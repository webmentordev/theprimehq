<footer class="w-full bg-dark">
    <div
        class="max-w-7xl m-auto py-12 px-4 grid grid-cols-4 gap-6 border-b border-light 1000px:grid-cols-3 700px:grid-cols-2 530px:grid-cols-1">
        <div class="flex flex-col">
            <img src="{{ asset('images/the-prime-hq-logo-white.png') }}" width="200" alt="ThePrimeHQ Logo"
                class="mb-6">
            <p class="text-white">{{ __('messages.footer.para') }}</p>
        </div>
        <div>
