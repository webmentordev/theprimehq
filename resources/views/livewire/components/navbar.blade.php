<nav class="w-full bg-white py-2 px-4">
    <div class="flex items-center justify-between max-w-7xl m-auto">
        ...
        <ul class="font-semibold">
            <a class="mx-6 hover:text-primary" href="{{ route('home') }}" wire:navigate>{{ __('messages.navbar.home') }}</a>
            <a class="mx-6 hover:text-primary" href="{{ route('about') }}" wire:navigate>{{ __('messages.navbar.about') }}</a>
            <a class="mx-6 hover:text-primary" href="{{ route('purchase') }}" wire:navigate>{{ __('messages.navbar.purchase') }}</a>
