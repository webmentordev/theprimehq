<section class="w-full">
    <div class="max-w-7xl m-auto py-6 px-4 grid grid-cols-2 min-h-[600px]">
        <div class="flex items-center justify-center">
            <div class="h-fit w-full">
                ...
                <a href="{{ route('purchase', ['locale' => app()->getLocale()]) }}" wire:navigate
                    class="px-4 py-3 bg-primary rounded-lg w-fit flex items-center text-white font-semibold">
                    {{ __('messages.purchase.button') }}
                    <img src="https://api.iconify.design/gravity-ui:shopping-bag.svg?color=%23ffffff" class="ml-2"
                        width="20" alt="Cart icon">
                </a>
            </div>
        </div>
        <div class="flex items-center justify-center">
            <img src="{{ asset('images/products/auto-und badreinigungs-mikrofaserhandtuch-in-deutschland.png') }}"
                title="{{ __('messages.quality') }}" alt="{{ __('messages.quality') }}">
        </div>
    </div>

    <div class="max-w-7xl m-auto py-6 px-4 grid grid-cols-2 gap-6 mb-12">
        <img src="{{ asset('images/products/the-prime-hq-car-towels-features.jpg') }}" class="w-full rounded-lg"
            title="{{ __('messages.features.feature') }}" alt="{{ __('messages.features.feature') }}">
        <div class="py-6 px-4">
    ...
    <div class="max-w-7xl m-auto py-6 px-4 grid grid-cols-2 gap-6 mb-12">
        <div class="py-6 px-4">
            <h1 class="font-bold text-4xl mb-3 pb-4 border-b border-gray-200">
                {{ __('messages.applications.application') }}</h1>
        ...
        <img src="{{ asset('images/products/the-prime-hq-car-towels-reusability-and-durability.png') }}"
            class="w-full rounded-lg" title="{{ __('messages.applications.application') }}"
            alt="{{ __('messages.features.application') }}">
    </div>

    <div class="max-w-7xl m-auto py-6 px-4 grid grid-cols-2 gap-6 mb-12">
        <img src="{{ asset('images/products/the-prime-hq-multipurpose-car-cleaning-towel.jpg') }}"
            class="w-full rounded-lg" title="{{ __('messages.multipurpose.message') }}"
            alt="{{ __('messages.multipurpose.message') }}">
        <div class="py-6 px-4">
            <h1 class="font-bold text-4xl mb-3 pb-4 border-b border-gray-200">{{ __('messages.multipurpose.message') }}
            </h1>
    ...
    <div class="max-w-7xl m-auto pt-6 pb-[100px] px-4 grid grid-cols-2 gap-6">
        <div class="py-6 px-4">
            <h1 class="font-bold text-4xl mb-3 pb-4 border-b border-gray-200">{{ __('messages.dimensions.message') }}
            </h1>
        ...
        <img src="{{ asset('images/products/the-prime-hq-car-towel-dimension-and-scratch-free.jpg') }}"
            class="w-full rounded-lg" title="{{ __('messages.dimensions.title') }}"
            alt="{{ __('messages.dimensions.title') }}">
    </div>
</section>
